...
4. In {language}, strengthen the summary. The summary should not exceed 5 sentences. \
...
5. Format your response as a dictionary with the following keys: evaluation__summary, score__summary, CV__summary_enhanced.
...
2. Considering the job description {jd} 
3. Suggest in {language} how to make the work experience text better and stronger.
4. Strengthen the work experience text to make it more appealing to a recruiter in {language}. \
...
5. Format your response as a dictionary with the following keys: "Score__WorkExperience", "Comments__WorkExperience" and "Improvement__WorkExperience".
...
2. Considering the job description {jd} 
3. Suggest in {language} how to make the project text better and stronger.
4. Strengthen the project text to make it more appealing to a recruiter in {language}, \
including the problem, the approach taken, the tools used and quantifiable results. \
Format your text as a string in {language}.
5. Format your response as a dictionary with the following keys: Score__project, Comments__project, Improvement__project.
...
2. Considering the job description {jd} 
3. Provide a comprehensive analysis of the three main strengths of the resume in {language}. \
Format the top 3 strengths as string containg three bullet points.
4. Provide a comprehensive analysis of the  corrections of the resume based on the job description {jd} in {language}. \
Format the top corrections as string containg  bullet points.
5. Format your response as a dictionary with the following keys: resume_cv_overview, top_3_strengths, top_corrections.
The strengths and weaknesses lie in the format, style and content of the resume.

Resume: ```{text}```
"""

PROMPT_MISSING_KEY = """You are given a resume delimited by triple backticks. 
1. Provide an overview of the resume in {language}.
2. Considering the job description {jd} 
3. Act Like a skilled or very experienced ATS(Application Tracking System)
The strengths and weaknesses lie in the format, style and content of the resume. with a deep understanding of tech field, software engineering, data Science, data analyst
and big data engineer. 
4.Your task is to evaluate the resume based on the given job description
you must consider the job market is very competitive and you should provide best assistance for improving the resume. Assign the percentage Matching based on job description and the missing keywords with the high accuracy.
5. tailor my resume  per the job description {jd} considering my {PROFESSIONAL_EXPERIENCE} and {SKILLS_and_CERTIF} see that they are alter these as per the job description
6. I need 6 to 10 tailor_Suggetions like adding skill set or altering the projects which could increse the job_match percentage as per the job description {jd} provide me direct changes so that i can copy paste.
7. Format your response as a dictionary with the following keys: JD_Match, MissingKeywords, Profile_Summary, tailor_Suggetions.
Resume: ```{text}```
job description: ```{jd}```
"""
